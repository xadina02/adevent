...
Route::get('members/show/3', [UserController::class, 'show'])->name('members/edit');
...
Route::get('events/show/3', [EventController::class, 'show'])->name('events/edit');
...
Route::get('events/participants/3', [ParticipantController::class, 'index'])->name('events/participants');
Route::post('events/participants/3', [ParticipantController::class, 'remove'])->name('events/participants/remove');
Route::post('events/participants/3', [ParticipantController::class, 'add'])->name('events/participants/add');
